...
/opt/homebrew/bin/youtube-dl -f bestvideo+bestaudio "$videoURL" -o "$videoDirectory/$videoTitle.%(ext) --merge-output-format mp4 --ffmpeg-location /opt/homebrew/bin/ffmpeg" & wait
